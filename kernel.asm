; ==================================================================
; NashOS -- An Operating System kernel written in Assembly
; by Nalindu Ashirwada. This OS is inspired by MikeOS. Great thanks
...
welcome_string      db 'Welcome to NashOS by Nalindu Ashirwada!', 0
prompt_string       db 'NashOS :) >> ', 0
